...
export interface ComponentTypeInterfaceMap {
...
export type AddComponentInterface =  UnionToIntersection<
ComponentEnum extends infer T ?
T extends ComponentEnum ? (type: T, data: ComponentTypeInterfaceMap[T]) => void :
never: never
>   